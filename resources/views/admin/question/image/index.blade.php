                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-position"><a href="{{ url('admin/learning') }}"><i class="fa fa-home"
                                ...
                                href='#'>トレーニング管理　〉画像・イラスト登録</a></h5>
                        <div style="display:flex">
                            <h2 class="card-title" style="width:90%">イラスト登録</h2>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            <div class="card-form justify-content-between">
                                <div class="row">
                                    <form id="form-add-question" class="form-vr scroll_to" style="min-width:fit-content; width:100%"
                                        action="" method="GET">
                                            ...
                                            <fieldset class="form-group info-box-vr d-flex"
                                                ...
                                                <div class="add-vr" style="width:645px">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="info-file info-2D-file" style="margin-left:-504px">
                                                            <input type="file" accept=".jpg,.png,.jpeg" class="vr"
                                                ...
                                                <div class="mass-registration" style="margin-top:-8px; margin-left:50px">
                                                    <div class="info-regist" style="width:300px">
                                                        ...
                                                        <input id="question_type" name="question_type" value="3"
                                                            hidden>
                                                    </div>
                            ...
                            <div id="questions_data">
                                @include('admin.question.image.grid')
                            </div>
                        </div>
                    </div>
                </div>
