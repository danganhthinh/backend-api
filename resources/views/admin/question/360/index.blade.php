                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-position"><a href="{{ url('admin/learning') }}"><i class="fa fa-home"
                                    aria-hidden="true" style="font-size: 14px"></i></a> 〉<a
                                href='#'>トレーニング管理　〉360°動画</a></h5>
                        <div style="display:flex">
                            <h2 class="card-title" style="width:90%">360°動画</h2>
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body">
                                            ...
                                            <div class="col-xl-2 col-lg-6 col-md-12 mb-1 form-add-vr">
                                                <fieldset class="form-group info-box-vr d-flex"
                                                    ...
                                                    <div class="add-vr" style="width:645px">
                                                        <div class="d-flex">
                                                            <label for="" class="add-2D-title">画像</label>
                                                            <div class="info-file info-2D-file" style="margin-left:-504px">
                                                                <input type="file" accept=".mp4" class="vr"
                                                                    name="image" id="question_media">
                                                                <label class="label-choose-file" style="width:200px"
                                                                    for="question_media">ファイルを選択</label>
                                                                {{-- <div class="file-name" id="question_media_name"></div> --}}
                                                                <p class="error-text" id="question-error-media"
                                                                    style="margin-left: 6%; margin-top: -1%; width: 100%;">
                                                                    &nbsp;</p>
                                                            </div>
                                                            <img id="illustration_preview" class="preview-2D"
                                                                src='/backend/images/icons/default.png' alt=""
                                                                height="150px" width="200px">
                                                            <video id="video_preview" width='200px' height='150px'
                                                                class="preview-2D" controls
                                                                style="display:none; border-radius: 16px; background-color:black">
                                                                <source id="video_preview_src" src=''
                                                                    type='video/mp4'>
                                                            </video>
                                                        </div>
                                                        <div class="d-flex title-2D" style="width:659px">
                                                            <label for="" class="title-2D-label"
                                                                style="width: 82px;">問題</label>
                                                            <textarea name="title" id="title" class="input-question" style="margin-top:4%"></textarea>
                                                        </div>
                                                        <p class="error-text" id="question-error-title"
                                                            style="margin-left: 116px; margin-top: 154px;">&nbsp;</p>
                                                    </div>
                                                        ...
                                                        <div class="info-regist" style="width:300px">
                                                            ...
                                                            <div id="4_answers">
                                                                ...
                                                                <div class="publishing-settings"
                                                                    ...
                                                                    <select name="correct_answer" id="correct_4_answer"
                                                                        ...
                                                                        <option value="1" class="text-center">1
                                                                        </option>
                                                                        <option value="2" class="text-center">2
                                                                        </option>
                                                                        <option value="3" class="text-center">3
                                                                        </option>
                                                                        <option value="4" class="text-center">4
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="publishing-settings" id="correct_true_false"
                                                                ...
                                                                <select name="correct_answer" id="correct_answer"
                                                                    ...
                                                                    <option value="1" class="text-center">TRUE
                                                                    </option>
                                                                    <option value="2" class="text-center">FALSE
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <input id="question_type" name="question_type" value="5"
                                                                hidden>
                                                        </div>
                                ...
                                <div id="questions_data">
                                    @include('admin.question.360.grid')
                                </div>
                            </div>
                        </div>
                    </div>
